...
$(document).ready(function () {
    ...
    // 关键词：多选
    $(".keyword-bar a").click(function () {
        $(this).toggleClass("keyword-click");
    });
    ...
    $(".key-add-btn").click(function () {
        $(this).next(".key-add-input").removeClass("none");
        $('input', $holder).val('');
    });
    $(".key-off").click(function() {
        $(this).parents(".key-add-input").addClass("none");
    ...
    $("#key-add").click(function () {
        ...
        if (keyValue == "") {
            ...
            if ($item && $item.length > 0) {
                ...
                $(this).parents(".table-item").find(".keyword-bar").append("<a href='javascript:void(0);' class='keyword-click keyword-add-val'>" + keyValue + "<i class='ico-diag i-diag11'></i></a>");
            }
        }
    });
    ...
    $(".children-add").click(function () {
        peopleNumber--;
        $(this).parents(".table-item").append('<div class="clearfix mt10 children-list"><div class="u-pn fl w305 mr10 z-' + peopleNumber + '"><div class="pn-ct"><span class="pn-on">子女年龄<i class="arrow"></i></span><ul class="pn-more"><li>下拉11</li><li>下拉22</li><li>下拉33</li><li>下拉44</li><li>下拉55</li><li>下拉66</li></ul></div></div><input type="text" placeholder="孩子生活情况描述" class="u-fm u-tx fl mr10" style="width:270px;"></div>');
    });
